...
"Ad lucem « Pour la lumière. » Ad majorem Dei gloriam « Pour la plus grande gloire de Dieu. »",
...
"Audi alteram parte « Qu'on entende l'autre partie également. »",
"Aura popularis « Le vent (inconstant et variable) de la faveur populaire. »",
"Auri mediocritas « Médiocrité de l'or. »",
...
"Cætera desunt « Tout ce qui manque. » (latin médiéval)",
"Camera obscura « Chambre noire. »",
"Canes pugnax « Chien d'attaque ; chien méchant. »",
...
"Cetera desunt « Tout ce qui manque. »",
...
"Cœtera desunt « Tout ce qui manque. » (latin médiéval)",
...
"Cujusvis hominis est errare « Il appartient à tout homme de se tromper. »",
...
"Non una cum « Ne reconnait pas l'autorité du Page. »",
...
"Sensus stricto « signifiant au sens strict. »",
...
class LatinExprFr(object):
	...
	@staticmethod
	def print_random_expr():
		print(self.random_expr())
